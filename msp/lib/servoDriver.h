...
#define SERVO_TMR_PERIOD 59 // ticks for 50Hz signal
#define SERVO_MIN_ANGLE 30  // ticks for 0.75ms pulse
#define SERVO_MAX_ANGLE 6  // ticks for 2.25ms pulse
#define TEN_DEGREE_TICKS 2 // ticks 10 degree shift
